...
class GbBlogParse:
    ...
    def get_comment(self, comment_data, comment_list=None):
        ...
        if comment_data:
            for i in comment_data:
                comment_dict = dict()
                comment_dict["id"] = i["comment"]["id"]
                comment_dict["parent_id"] = i["comment"]["parent_id"]
                comment_dict["body"] = i["comment"]["body"]
                comment_list.append(comment_dict)
                if i["comment"]["children"]:
                    self.get_comment(i["comment"]["children"], comment_list)
    ...
    def parse_post(self, url, soup):
        ...
        data = {
            ...
            "author_data": {
                "url": urljoin(url, author.parent.attrs.get("href")),
                "name": author.text,
            },
            "tags_data": [
            ...
            "comments_data": self.get_comment(comment_data),
        }
